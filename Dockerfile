...
# https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.0.0-EAP06-x64.bin
# https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.0.0-EAP06.tar.gz
MAINTAINER Dmitry Gerasimov <q2digger@gmail.com>

ENV JIRA_VERSION 8.0.0-EAP06
...
RUN set -x \
    ...
    && curl -Ls                "https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.0.0-EAP06.tar.gz" | tar -xz --directory "${JIRA_INSTALL_DIR}" --strip-components=1 --no-same-owner \
