...
# https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.0.0-EAP02-x64.bin
# https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.0.0-EAP02.tar.gz
...
RUN set -x \
    ...
    && curl -Ls                "https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.0.0-EAP02.tar.gz" | tar -xz --directory "${JIRA_INSTALL_DIR}" --strip-components=1 --no-same-owner \
